    ...
    render() {
        ...
        return (
            <div className="shiftTimes flexItem">
                <h3>Shift Times</h3>
                <form id="shift_times">
                    <div>Start Time: &nbsp; <input type="time" onChange={setStartTime} id="start_shift" list="times_list" /></div>
                    <h4>Breaks</h4>
                    <Breaks setStartBreak={setStartBreak} setEndBreak={setEndBreak} />
                    {/* <button className="removeBreak">Remove Break</button>
                    <button className="addBreak">Add Break</button> */}
                    <br />
                    <div>End Time: &nbsp; <input type="time" onChange={setEndTime} id="end_shift" list="times_list" /></div>
                </form>
